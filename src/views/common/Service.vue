            ...
            <div class="row">
                ...
                <div class="col-md-6 host-h col-lg-4">
                    <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-md-4 mt-lg-4">
                        <img src="@/assets/img/1hos.png" alt="shared hosting" class="img-fluid images mb-4"
                            width="45" />
                ...
                <div class="col-md-6 host-h col-lg-4">
                    <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-md-4 mt-lg-4">
                        ...
                        <div class="service-plane-content serve">
                            ...
                            <p>Specialized e-commerce hosting optimized for online stores, ensuring security,
                                scalability,
                ...
                <div class="col-md-6 host-h col-lg-4">
                    <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-md-4 mt-lg-4">
                        ...
                        <div class="service-plane-content serve">
                            ...
                            <p>Increased speed and resources with our virtual private servers are perfect for developers
                ...
                <div class="col-md-6 host-h col-lg-4">
                    <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-md-4 mt-lg-4">
                        ...
                        <div class="service-plane-content serve">
                            ...
                            <p>Manage your site on your own dedicated server for maximum control, traffic capacity,
                                and security.</p>
                        </div>
                        <div class="cart-home">
            ...
            <div class="row">
                <div class=" host-h col-md-6 col-lg-4 col-12">
                    <div class="technical-specifications-wrap mt-md-5 mt-lg-5">
                        ...
                        <ul class="list-unstyled tech-feature-list">
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Ultra-fast SSD
                                storage and advanced servers</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Simple scripts
                                and
                                database management</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Automatic
                                scaling to
                                meet demand</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Air-gapped
                                security
                                and DDoS protection</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>99.9% uptime
                                guarantee</li>
                        </ul>
                    </div>
                </div>
                <div class=" host-h col-md-6 col-lg-4 col-12">
                    <div class="technical-specifications-wrap mt-md-5 mt-lg-5">
                        ...
                        <ul class="list-unstyled tech-feature-list">
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Easy-to-use
                                interface</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Automated tasks
                                to
                                save you time</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Manage domains,
                                files, databases, and more</li>
                            <li class="py-1"><span
                                    class="ti-control-forward mr-2 color-primary"></span><strong>Password</strong>Add
                                emails, subdomains, etc</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Simplify DNS
                                management</li>
                        </ul>
                    </div>
                </div>
                <div class=" host-h col-md-6 col-lg-4 col-12">
                    <div class="technical-specifications-wrap mt-md-5 mt-lg-5">
                        ...
                        <ul class="list-unstyled tech-feature-list">
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Supports common
                                languages/frameworks</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>SSL
                                Certification
                            </li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>MySQL databases
                                with
                                phpMyAdmin</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>SSH access for
                                development</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Real-time
                                database
                                backups to protect your data</li>
                        </ul>
                    </div>
                </div>
                <div class="host-h col-md-6 col-lg-4 col-12">
                    <div class="technical-specifications-wrap mt-md-5 mt-lg-5">
                        ...
                        <ul class="list-unstyled tech-feature-list">
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Fast setup of
                                professional emails</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Integrated email
                                marketing tools</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Anti-spam and
                                security filters</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Access mail
                                anywhere
                                via webmail</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Automated
                                responses
                                and autoresponder capabilities</li>
                        </ul>
                    </div>
                </div>
                <div class="host-h col-md-6 col-lg-4 col-12">
                    <div class="technical-specifications-wrap mt-md-5 mt-lg-5">
                        ...
                        <ul class="list-unstyled tech-feature-list">
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>24/7 expert
                                support
                                by chat, phone, and tickets</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Extensive
                                knowledge-based articles and video tutorials</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Proactive
                                monitoring
                                and emergency response</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Free
                                consultations
                                for complex issues</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Scheduled data
                                backups</li>
                        </ul>
                    </div>
                </div>
                <div class="host-h col-md-6 col-lg-4 col-12">
                    <div class="technical-specifications-wrap mt-md-5 mt-lg-5">
                        ...
                        <ul class="list-unstyled tech-feature-list">
                            ...
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Caching and
                                content
                                delivery network</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Extra security
                                protection available</li>
                            <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span>Customizable
                                server
                                configuration</li>
                        </ul>
                    </div>
