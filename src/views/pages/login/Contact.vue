            ...
            <div class="row align-items-center">
                <div class="col-md-7 col-lg-6">
                    <div class="page-header-content text-white">
                        <h1 class="text-hup media-lan">Contact Us</h1>
                        <p class="lead">
                            Gain access to vibrant multidisciplinary communities and dependable quality vectors with
                            enthusiasm. We administer
                            robust solutions globally, fostering collaboration and excellence across diverse domains,
            ...
            <div class="row justify-content-around">
                ...
                <div class="col-md-6">
                    <div class="contact-us-form gray-light-bg rounded p-5">
                        ...
                        <form action="#" method="POST" id="contactForm" class="contact-us-form mt-3"
                            ...
                            <div class="single-testimonial white-bg shadow-sm rounded p-5">
                                ...
                                <div class="ratting-content">
                                    ...
                                    <p>Objectively magnetic manufactured products and dynamic models.
                                        Progressively maximize 2.0 relationships imperatives through
                                        whereas process-centric.</p>
                                </div>
