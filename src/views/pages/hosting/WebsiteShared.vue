            ...
            <div class="row align-items-center">
                <div class="col-md-7 col-lg-8 media-shair ">
                    <div class="hero-content-wrap text-white position-relative">
                        <h1 class="text-hup media-sh">Website Shared Hosting</h1>
                        <p class="lead">Build and grow the perfect Website Shared Hosting Pro.</p>
                        <ul class="list-unstyled tech-feature-list text-white">
                            <li class="py-1"><span class="ti-control-forward mr-2"></span>Flexible, Easy to Use Control
                                Panel</li>
                            <li class="py-1"><span class="ti-control-forward mr-2"></span><strong>Unmetered</strong>
                                Bandwidth</li>
                            <li class="py-1"><span class="ti-control-forward mr-2"></span><strong>Unmetered</strong> Sub
                                Domains, FTP Accounts</li>
                            <li class="py-1"><span class="ti-control-forward mr-2"></span><strong>99%</strong> Uptime
                                Guarantee</li>
            ...
            <div class="row justify-content-center head">
                <div class="col-md-12 col-lg-7">
                    <div class="section-heading  text-center">
                        ...
                        <div>
                            <h6 class="h5 med-w ">
                                1year plan <span class="text-rd"> 10% </span> discount -<span class="text-rd">
                                    hostgift1yr</span>
                            </h6>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-9 col-12 nd-res order-xl-first">
                    ...
                    <p class="h5 web-s">Gradually integrate mission-critical core competencies without relying on fixed
                        paradigms.</p>
                    <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-testimonial white-bg shadow-sm rounded p-5">
                        ...
                        <div class="ratting-content">
                            ...
                            <p>I've been with this hosting service for over a year now, and I couldn't be happier. The
                                uptime is fantastic,
                ...
                <div class="col-md-6 mr-con col-lg-4">
                    <div class="single-testimonial white-bg shadow-sm rounded p-5">
                        ...
                        <div class="ratting-content">
                            ...
                            <p>Switching to this hosting service was one of the best decisions I made for my business.
                                The speed and reliability are top-notch,
                                and the pricing is very competitive. Plus, the user interface is intuitive and easy to
                                navigate.</p>
                        </div>
                        <div class="ratting-author mt-3">
                            <h6>Michael R.</h6>
                ...
                <div class="col-md-6 mr-con col-lg-4">
                    <div class="single-testimonial white-bg shadow-sm rounded p-5">
                        ...
                        <div class="ratting-content">
                            ...
                            <p>
                                Their customer support team goes above and beyond to assist with any issues, and their
                                servers are lightning-fast.
                                It's a no-brainer for me – I'll be sticking with this hosting service for the long haul
                            </p>
                        </div>
                        <div class="ratting-author mt-3">
                            <h6>Emily K.</h6>
